...
class VCD:
    ...
    def parse_file(self, filename):
        ...
        startAt = None  # Initialize startAt with a None value
        line = ""  # Initialize line to an empty string
        ...
        if startAt is None:
            print("Warning: $timescale not found in the file.")
            return  # exit the function early if $timescale is not found
        ...
        if line:
            ...
            print("Error: No valid timestep found in the VCD file.")
            return
